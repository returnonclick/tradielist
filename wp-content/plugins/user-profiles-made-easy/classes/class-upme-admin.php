...
class UPME_Admin {
    ...
    function __construct() {
        ...
        $this->option_with_checkbox = array('redirect_backend_profile', 'redirect_backend_registration', 'redirect_backend_login', 'link_author_posts_page', 'show_separator_on_profile', 'show_empty_field_on_profile'
            ...
            'profile_password_indicator','reset_password_indicator','visual_composer_shortcodes','login_forms_captcha');
...
<?php
        ...
        function upme_user_action_buttons() {
            ...
            $activate_profile_status        = __('Set Profile Status to Acitve','upme');
            $deactivate_profile_status      = __('Set Profile Status to Inacitve','upme');
