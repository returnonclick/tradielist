...
//        echo $this->search_query_string;
    ...
    function edit_profile_fields($id, $width=null, $sidebar_class=null) {
        ...
        global $predefined, $upme_roles, $upme_profile_fields, $upme_options;       
                            ...
                            case 'fileupload':
                                ...
                                if ($meta == 'user_pic') {
                                    ...
                                    if (get_the_author_meta('user_pic', $id) != '') {
                                        $display .= '<div class="upme-note upme-current-pic-note"><img id="upme-preview-user_pic" class="hide" src="' . get_the_author_meta('user_pic', $id) . '" alt="" />' . $display_delete_link . '</div>';
                                    } else {
    ...
    function show_register_form($sidebar_class=null, $redirect_to=null, $user_role=null, $registration_form_name=null,$display_login=null ) {
        ...
        if (!isset($upme_register->registered) || $upme_register->registered != 1) {
            ...
            $display .= '<form action="" method="post" id="upme-registration-form" enctype="multipart/form-data" >';
    ...
    function upme_profile_title_value($profile_title_field, $id) {
        ...
        if ('combined_fname_lname' == $profile_title_field) {
            ...
            $user_info = get_userdata($id);
            $profile_title_display = $user_info->user_login;
        } else {
    ...
    public function none_empty_field_labels($id,$view,$field_params,$profile_fields_key){
        ...
        if ($type == 'usermeta' && (get_the_author_meta($meta, $id) != '' || !$upme_custom_empty_field_type_status) && $deleted == 0) {
                                    ...
                                    if ($field == 'fileupload') {
                                        ...
                                        if (isset($profile_fields_key['allow_html']) && $allow_html == 1) {
                                            ...
                                            if ($meta == 'user_url' && $this->get_option('website_link_on_profile') == 1) {
                                                ...
                                                $profie_fieldval = get_the_author_meta($meta, $id);
