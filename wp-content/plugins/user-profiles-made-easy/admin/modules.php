...
<div class="wrap">
    ...
    <div class="updated" id="upme-modules-import-success" style="display:none;">
        <p><?php _e('Record Updated.', 'upme'); ?></p>
    </div>

    <div class="error" id="upme-modules-import-error" style="display:none;">
        <p><?php _e('No File Selected.', 'upme'); ?></p>
    </div>
    ...
    <div id="upme-tab-group" class="upme-tab-group vertical_tabs">
        <ul id="upme-tabs" class="upme-tabs">
            ...
            <li class="upme-tab " id="upme-site-export-import-settings-tab"><?php _e('Export / Import', 'upme'); ?></li>
        ...
        <div id="upme-tab-container" class="upme-tab-container" style="min-height: 325px;">
            <div class="upme-tab-content-holder">
                ...
                <div class="upme-tab-content" id="upme-site-export-import-settings-content" style="display:none;">
                    
                    <div id="upme-site-export-import-list">
                        <h3>
                            <?php _e('Export / Import', 'upme'); ?> 
                        </h3>
                        <div class='upme-module-settings-button-bar' >
                        <?php
                            echo UPME_Html::button('button',
                                array(
                                    'name' => 'upme-export-import-fields-btn',
                                    'id' => 'upme-export-import-fields-btn',
                                    'value' => __('Profile Fields', 'upme'),
                                    'class' => 'button-import-export button button-primary'));
                        ?>
                        <?php
                        echo UPME_Html::button('button',
                            array(
                                'name' => 'upme-export-import-settings-btn',
                                'id' => 'upme-export-import-settings-btn',
                                'value' => __('UPME Settings', 'upme'),
                                'class' => 'button-import-export button button-primary'));
                        ?>
                        ...
                        echo UPME_Html::button('button',
                            array(
                                'name' => 'upme-export-import-users-btn',
                                'id' => 'upme-export-import-users-btn',
                                'value' => __('UPME Users', 'upme'),
                                'class' => 'button-import-export button button-primary'));
                        ?>
                    ...
                    <div id="upme-export-import-fields-panel" class='panel-import-export' style="display:block">
                        ...
                        <!--Import Form-->
                        <div class='upme-module-settings-sub-title'><?php _e('Import Fields', 'upme'); ?></div>
                        <?php
                            ob_start();
                            $upme_template_loader->get_template_part('site_field_import_view');
                            echo ob_get_clean();
                        ?>


                        <!--Export Form-->
                        <div class='upme-module-settings-sub-title'><?php _e('Export Fields', 'upme'); ?></div>
                        <?php
                            ob_start();
                            $upme_template_loader->get_template_part('site_field_export_view');
                            echo ob_get_clean();
                        ?>
                    </div>
                    <div id="upme-export-import-settings-panel" class='panel-import-export' style="display:none">

                        <div class="updated" id="upme-add-site-settings-msg" style="display:none;"></div>

                        <!--Import Form-->
                        <div class='upme-module-settings-sub-title'><?php _e('Import Settings', 'upme'); ?></div>
                        <?php
                            ob_start();
                            $upme_template_loader->get_template_part('site_settings_import_view');
                            echo ob_get_clean();
                        ?>


                        <!--Export Form-->
                        <div class='upme-module-settings-sub-title'><?php _e('Export Settings', 'upme'); ?></div>
                        <?php
                            ob_start();
                            $upme_template_loader->get_template_part('site_settings_export_view');
                            echo ob_get_clean();
                        ?>
                    </div>
                    
                    <div id="upme-export-import-users-panel" class='panel-import-export' style="display:none">

                        <div class="updated" id="upme-add-site-settings-msg" style="display:none;"></div>

                        <!--Export Form-->
                        <div class='upme-module-settings-sub-title'><?php _e('Export Users', 'upme'); ?></div>
                        <?php
                            ob_start();
                            $upme_template_loader->get_template_part('site_users_export_view');
                            echo ob_get_clean();
                        ?>
                    </div>
