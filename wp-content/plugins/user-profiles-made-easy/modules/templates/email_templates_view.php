    ...
    <td>
        <?php 
            $email_templates = array(                                
                                ...
                                'reg_activation_approval_user'  => __('Registration with email confirmation and approval for Users', 'upme'),
                                'reg_activation_approval_admin' => __('Registration with email confirmation and approval for Admin', 'upme'),
                                'reg_activation_user'           => __('Registration with email confirmation for Users', 'upme'),
                                'reg_activation_admin'          => __('Registration with email confirmation for Admin', 'upme'),
                                'reg_approval_user'             => __('Registration with approval for Users', 'upme'),
                                'reg_approval_admin'            => __('Registration with approval for Admin', 'upme'),
                                ...
                                'delete_profile_confirm'        => __('Profile removal confirmation for users', 'upme'),
