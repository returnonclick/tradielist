...
<div class="row">
	<div class="col-md-5 col-sm-5 col-xs-12"> 
		...
		<div class="row">
			...
			<div class="col-md-8 col-sm-7 col-xs-12 business-data">
				<a class="listing-contact  listing--facebook" href="https://facebook.com/<?php echo $facebook; ?>" itemprop="url">@<?php echo $facebook; ?></a>
			</div>
		</div>
		<?php endif; ?>
	</div>
...
<div class="row">
	<div class="col-md-4 col-sm-5 col-xs-12 business-label"><?php esc_html_e( 'Address', 'listable' ); ?></div>
	<div class="col-md-8 col-sm-7 col-xs-12 business-data">
