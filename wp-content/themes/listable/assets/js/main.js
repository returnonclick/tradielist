...
(function($, undefined) {
    ...
    function moveSingleListingClaimWidget() {
        var $claimWidget = $('.widget_listing_sidebar_claim_listing');
        if ($claimWidget.length) {
            var $parentSidebar = $claimWidget.parent();

            if ($parentSidebar.hasClass('listing-sidebar--bottom')) {
                if ($claimWidget.is(':first-of-type')) {
                    $claimWidget.insertBefore($parentSidebar).addClass('is--independent');
                }

                if ($claimWidget.is(':last-of-type')) {
                    $claimWidget.insertAfter($parentSidebar).addClass('is--independent');
                }
            }
        }
    }
